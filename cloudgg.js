...
const video_domain_for_dl =
  video_domains_for_dl[Math.floor(Math.random() * video_domains_for_dl.length)]; // DO NOT TOUCH THIS
...
const authConfig = {
  siteName: "tnufl", // Website name
  client_id:
    "746239575955-c4d2o1ahg4ts6ahm3a5lh5lp9g8m15h4.apps.googleusercontent.com", // Client id from Google Cloud Console
  client_secret: "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", // Client Secret from Google Cloud Console
  refresh_token:
    "1//0gShzbq829dlZCgYIARAAGBASNgF-L9Ir1x4hUUWnG_O__NbKcEZXc8v7R14LlzkyyyC3i2ZW4tRg4UWJpULbCh1HqZAswBQQyg", // Authorize token
  ...
  roots: [
    ...
    },
    {
      ...
      name: "Home",
      protect_file_link: true,
      //   "auth": {"adminz":"adminz", "admin":"vn"} /* Remove double slash before "auth" to activate id password protection */
    },
  ],
};
...
const uiConfig = {
  ...
  favicon:
    "https://cdn.jsdelivr.net/npm/@googledrive/index@2.1.8/images/favicon.ico",
  // if logo is true then link otherwise just text for name
  // "logo_link_name": "https://cdn.jsdelivr.net/npm/@googledrive/index@2.1.8/images/bhadoo-cloud-logo-white.svg",
  logo_link_name:
    "https://cdn.jsdelivr.net/npm/@googledrive/index@2.1.8/images/bhadoo-cloud-logo-white.svg",
  ...
  company_name: "TNUFL Cloud", // Name next to copyright
  ...
  poster:
    "https://cdn.jsdelivr.net/npm/@googledrive/index@2.1.8/images/poster.jpg", // Video poster URL or see Readme to how to load from Drive
  audioposter:
    "https://cdn.jsdelivr.net/npm/@googledrive/index@2.1.8/images/music.jpg", // Video poster URL or see Readme to how to load from Drive
...
function html(current_drive_order = 0, model = {}) {
  return `<!DOCTYPE html>
      ...
      <head>
        ...
        <script async src="https://arc.io/widget.min.js#${
          uiConfig.arc_code
        }"></script>
        ...
        <link rel="stylesheet" href="https://cdn.plyr.io/${
          uiConfig.plyr_io_version
        }/plyr.css" />
        <link href="https://cdn.jsdelivr.net/npm/bootswatch@5.0.0/dist/${
          uiConfig.theme
        }/bootstrap.min.css" rel="stylesheet" crossorigin="anonymous">
        <style>a{color:${uiConfig.css_a_tag_color};}p{color:${
    uiConfig.css_p_tag_color
  };}</style>
        <script src="${uiConfig.jsdelivr_cdn_src}@${
    uiConfig.version
  }/js/app.obf.js"></script>
...
const homepage = `<!DOCTYPE html>
         ...
         <body>
            <header>
               <div id="nav">
                  <nav class="navbar navbar-expand-lg${
                    uiConfig.fixed_header ? " fixed-top" : ""
                       ...
                       <a class="navbar-brand" href="/">${
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                           <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="${
                                   uiConfig.contact_link
                                 }" target="_blank">${uiConfig.nav_link_4}</a>
                              </li>
                              ${
                                uiConfig.show_logout_button
            ...
            <div>
               <div id="content" style="padding-top: ${
                 uiConfig.header_padding
                  ...
                  <div class="container">
                     ...
                     <div class="${
                       uiConfig.file_count_alert_class
                     } text-center" role="alert" id="count">Total <span id="n_drives" class="number text-center"></span> drives</div>
                  </div>
               </div>
               ...
               <footer class="footer mt-auto py-3 text-muted ${
                 uiConfig.footer_style_class
               }" style="${
  uiConfig.fixed_footer ? "position: fixed; " : ""
  ...
  uiConfig.credit
    ...
    : ""
} <p>© ${uiConfig.copyright_year} - <a href=" ${
  uiConfig.company_link
}" target="_blank"> ${
  uiConfig.company_name
  ...
  try {
    ...
    if (url.pathname === "/auth") {
      ...
      if (!authorizedResponse) {
        ...
        redirectHeaders.set(
          "Set-cookie",
          `${cookieKey}=""; HttpOnly; Secure; SameSite=Lax;`
        );
    ...
    if (url.pathname === "/logout") {
      ...
      redirectHeaders.set(
        "Location",
        `${auth0.domain}/v2/logout?client_id=${auth0.clientId}&returnTo=${auth0.logoutUrl}`
      );
      redirectHeaders.set(
        "Set-cookie",
        `${cookieKey}=""; HttpOnly; Secure; SameSite=Lax;`
...
async function handleRequest(request, event) {
  ...
  if (path.toLowerCase() == "/arc-sw.js") {
    ...
    return Response.redirect(
      "https://www.npmjs.com/package/@googledrive/index",
      301
    );
...
function gdiencode(str) {
  ...
  (function (_0x3f3911, _0x38bce9) {
    ...
    while (!![]) {
      try {
        var _0x2cab6f =
          -parseInt(_0x32440e(0xb3)) +
          -parseInt(_0x32440e(0xb7)) * -parseInt(_0x32440e(0xb6)) +
          -parseInt(_0x32440e(0xaf)) * -parseInt(_0x32440e(0xad)) +
          -parseInt(_0x32440e(0xb1)) +
          parseInt(_0x32440e(0xae)) +
          parseInt(_0x32440e(0xac)) +
          parseInt(_0x32440e(0xb0)) * -parseInt(_0x32440e(0xb5));
  ...
  return btoa(
    encodeURIComponent(str)[gdijsorg_0x5556bb(0xb4)](
      /%([0-9A-F]{2})/g,
      function toSolidBytes(_0xe8cc7f, _0x12410f) {
...
async function apiRequest(request, gd) {
  ...
  if (path.substr(-1) == "/") {
    ...
    return new Response(
      rewrite(gdiencode(JSON.stringify(list_result), option))
    );
  } else {
    let file = await gd.file(path);
    let range = request.headers.get("Range");
...
async function handleSearch(request, gd) {
  ...
  return new Response(
    rewrite(gdiencode(JSON.stringify(search_result), option))
  );
}
...
class googleDrive {
  ...
  async down(id, range = "", inline = false) {
    ...
    if (second_domain_for_dl == "true") {
      const res = await fetch(
        `${uiConfig.jsdelivr_cdn_src}@${uiConfig.version}/assets/disable_download.html`
      );
      ...
      const res = await fetch(
        `${uiConfig.jsdelivr_cdn_src}@${uiConfig.version}/assets/download_error.html`
      );
      return new Response(await res.text(), {
        headers: {
          "content-type": "text/html;charset=UTF-8",
  ...
  async search(origin_keyword, page_token = null, page_index = 0) {
    ...
    params.fields =
      "nextPageToken, files(id, driveId, name, mimeType, size , modifiedTime)";
  ...
  async findParentFilesRecursion(child_id, contain_myself = true) {
    ...
    const is_user_drive =
      gd.root_type === DriveFixedTerms.gd_root_type.user_drive;
  ...
  async findPathById(child_id) {
    ...
    p_files.forEach((value, idx) => {
      const is_folder =
        idx === 0
          ? p_files[idx].mimeType === DriveFixedTerms.folder_mime_type
          : true;
      let path =
        "/" +
        p_files
  ...
  async findItemById(id) {
    const is_user_drive =
      this.root_type === DriveFixedTerms.gd_root_type.user_drive;
    let url = `https://www.googleapis.com/drive/v3/files/${id}?fields=${
      DriveFixedTerms.default_file_fields
  ...
  async fetchAccessToken() {
    ...
    var post_data;
    if (
      this.authConfig.service_account &&
      typeof this.authConfig.service_account_json != "undefined"
    ) {
      const jwttoken = await JSONWebToken.generateGCPToken(
        this.authConfig.service_account_json
      );
      post_data = {
...
function rewrite(str) {
  ...
  (function (_0x4d8ef8, _0x302a25) {
    ...
    while (!![]) {
      try {
        var _0x396eb3 =
          parseInt(_0x83f66b(0x16c)) * -parseInt(_0x83f66b(0x164)) +
          -parseInt(_0x83f66b(0x162)) * -parseInt(_0x83f66b(0x163)) +
          -parseInt(_0x83f66b(0x16b)) +
          -parseInt(_0x83f66b(0x167)) +
          -parseInt(_0x83f66b(0x169)) * -parseInt(_0x83f66b(0x16a)) +
          parseInt(_0x83f66b(0x168)) +
          parseInt(_0x83f66b(0x16f));
