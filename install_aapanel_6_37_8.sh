...
Install_Bt() {
    ...
    # wget --no-check-certificate -O /etc/init.d/bt ${download_Url}/install/src/bt6_en.init -t 5 -T 20
    # wget --no-check-certificate -O /www/server/panel/init.sh ${download_Url}/install/src/bt6_en.init -t 5 -T 20
